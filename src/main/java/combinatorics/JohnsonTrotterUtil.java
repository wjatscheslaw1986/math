 ...
 */
public class JohnsonTrotterUtil {
     ...
     */
    public static void print(int n, OutputStream o, Function<int[], String> formatter) {
        generate(n, getPrintIntArrayFunction(o, formatter));
    }
