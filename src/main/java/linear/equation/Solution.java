 ...
 * @param solution a zero solution which is either a single solution for the case of {@link SolutionsCount#SINGLE},
 *                 or a solution with all variable terms are zeroes for the case of {@link SolutionsCount#INFINITE},
 *                 or {@code null} for the case of {@link SolutionsCount#ZERO}
 * @param basis a basis on linear space of solutions for current linear equation system
 *                  or {@code null} for the cases of {@link SolutionsCount#ZERO} and {@link SolutionsCount#SINGLE}
