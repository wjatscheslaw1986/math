...
public class EquationValidatorTest {
    ...
    void given_linear_equations_when_check_for_type_assert_quadratic_and_not_anything_else() {
        var equation1 = new Equation(List.of(
                ...
                Term.builder().coefficient(-7).letter("x").power(0.0d).build(),
        ...
        var equation2 = new Equation(List.of(
                Term.builder().coefficient(7).letter("x").power(1.0d).build(),
                Term.builder().coefficient(17).letter("x").power(1.0d).build(),
                Term.builder().coefficient(27).letter("x").power(1.0d).build(),
                Term.builder().coefficient(37).letter("x").power(1.0d).build(),
                Term.builder().coefficient(7).letter("x").power(1.0d).build(),
