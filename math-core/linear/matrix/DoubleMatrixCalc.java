...
//                matrix[2][1] * matrix[1][2] * matrix[0][0]);
	...
	/**
	 * This method produces a trapezoid matrix of any matrix or simply returns the
	 * original matrix back. This method does not modify the original matrix object
	 *
	 * @param matrix - a link to original matrix argument object
	 * @return trapezoid for of matrix argument or null if the method failed to form
	 *         a trapezoid matrix
